...
import {ADD_ITEM_ERROR, ADD_ITEM_SUCCESS, GET_PRODUCTS_ERROR, HTTP_REQUEST_ERROR} from "../../../shared/messages";
...
export class DashboardComponent implements OnInit {
  ...
  getAllProduct(): void {
    this.api.execute(this.customerService.getAllProducts(), {
  ...
  searchProducts(): void {
    ...
    if (!!searchTerm) {
      this.api.execute(
        this.customerService.getAllProductsByName(searchTerm),
