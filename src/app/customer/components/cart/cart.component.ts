...
export class CartComponent implements OnInit {
  ...
  applyCoupon(): void {
    ...
    this.api.execute(this.customerService.applyCoupon(code), {
  ...
  increaseProductQuantity(productId: number): void {
    this.api.execute(this.customerService.increaseProductQuantity(productId), {
      errorMessage: ADD_ITEM_ERROR.replace('#', 'product')
    }).subscribe(() => this.getCart());
  }

  decreaseProductQuantity(productId: number): void {
    this.api.execute(this.customerService.decreaseProductQuantity(productId), {
